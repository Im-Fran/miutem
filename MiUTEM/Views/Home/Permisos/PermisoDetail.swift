...
struct PermisoDetail: View {
    ...
    var body: some View {
        ...
        .onAppear {
            appService.permisoService.getPermisoDetallado(permisoSimple: permisoSimple, credentials: appService.authService.getStoredCredentials())
                .receive(on: DispatchQueue.main)
                .sink(receiveCompletion: { _ in }, receiveValue: { permiso in
